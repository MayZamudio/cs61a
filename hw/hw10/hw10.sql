...
CREATE TABLE sentences AS
  SELECT "The two siblings, " || z.first || " plus " || z.second || " have the same size: " || x.size
  FROM size_of_dogs AS x, size_of_dogs AS y, siblings AS z
  WHERE x.size = y.size AND x.name = z.first AND y.name = z.second;
